...
class Generator:
    ...
    def __init__(self, site):
        ...
        self.templates.env.filters["html2gemini"] = self._html2gemini
        self.templates.env.filters["md2gemini"] = self._md2gemini
    ...
    def _html2gemini(self, html):
        soup = BeautifulSoup(html, features="html.parser")
        return soup.text
    
    def _md2gemini(self, md):
        return md2gemini(md, links="paragraph")
    ...
    def generate_resource(self, resource):
        ...
        if not resource.name.endswith(".html"):
            return "Not yet supported, sorry."  # TODO
